document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Если элементов корзины нет на странице, прекращаем выполнение
    if (!container || !cartList) return;
    ...
    function renderCart() {
        ...
        cart.forEach(item => {
            ...
            // Since we are in pages/cart/cart.html, and images are in ../../images/
            // and item.image in JSON is "images/..."
